...
Write-Host "========================================"
Write-Host " RabbitTun Client (exe)"
Write-Host "========================================"
Write-Host ""

Write-Host "[1/2] Starting tunnel ($ComPort -> :9000) ..."
Start-Process -FilePath $exe -ArgumentList "$ComPort --mode tunnel --listen 9000" -WindowStyle Hidden
...
Write-Host ""
& (Join-Path $PSScriptRoot "gost.exe") -L socks://:1080 -L http://:8080 -F relay+ws://127.0.0.1:9000
